...
$(this).parent().parent().find('.assign_class').html('<select id="classes_selc"><option>Nurery</option><option>L.K.G</option><option>U.K.G</option><?php for($i=1;$i<=12;$i++){ echo "<option>".$i."th"." "."Grade"."</option>"; }  ?></select>');
